...
config = FFConfig.load_or_init(load_path='auto', default_fpath=gl.repo_dir / 'misc/config_v1.0.6_default_ru.yaml',
                               init_debug=False, init_version='v1.0.6')
