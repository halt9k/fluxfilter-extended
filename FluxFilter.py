...
# %% id="ukl734CBblay"
qc = {}
qc['h'] = 7  # Если система флагов была 1-9, поправить
qc['le'] = 7  # Если система флагов была 1-9, поправить
qc['co2_flux'] = 7  # Если система флагов была 1-9, поправить
qc['ch4_flux'] = 7  # Если система флагов была 1-9, поправить
if not config.from_file:
    config.qc = qc
