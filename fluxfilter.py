# -*- coding: utf-8 -*-
"""Копия блокнота FluxFilter093dev_Iga

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/16Xw0g3soq8xgwDOYv066pnqbktfE-YT6
...
meteo_filter_config['day_nee_limit'] = 10
...
if config_meteo['use_biomet'] and 'ta_1_1_1' in eddy_df:
...
if config_meteo ['use_biomet']:
  ...
  # TODO this is just a draft, probably T switch should be redirected properly into common data from the very import
  if 'ta_1_1_1' not in fat_df:
...
Недостаточная турбулентность определяет границу применимости метода Eddy Covariance. При скорости потоков (столбец *uStar*) ниже определенного порога поток CO2 может быть занижен. Данные, соответствующие этим условиям, заменяются на пропуски.
...
Метод `Reichstein05` для ночного времени и/или `Lasslop10` для дневного. Для разделения потоков обязательно пристутствие столбца *Rg* в данных.  
...
Включение заполнения пропусков    
