...
is_ustar = ig.eddyproc_options.is_to_apply_u_star_filtering
...
tag_handler = EddyImgTagHandler(main_path='output/reddyproc',
                                eddy_loc_prefix=ig.eddy_out_prefix, img_ext='.png')
eio = EddyOutput(output_sequence=output_sequence, tag_handler=tag_handler)
eio.prepare_images()

arc_path = create_archive(dir='output/reddyproc', arc_fname=ig.eddy_out_prefix + '.zip',
